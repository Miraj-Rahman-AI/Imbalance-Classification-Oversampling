...
import _smote_variants_v6_Gsmote as _smote_variants_v6_Gsmote
import _imblearn_v2_Wsmote as _imblearn_v2_Wsmote
import _smote_variants_v7_GBsmote
import _smote_variants_v2_Wsmote as _smote_variants_v2_Wsmote   # W-smotes
import _smote_variants_v3_SW as _smote_variants_v3_SW   # SW
...
:return:
    ...
    try:  
        ...
        for i in range(0, index):
            for j in range(0, len(value_write[i])):
                #  sheet.write(i, j, str(value_write[i][j])) ??
...
def sampling_methods(data_train=None, RData=None,method=None, parameters=(30, 5), random_state=42, weight_WNND=None,weight_SW=None,ntree=None,nans=None):
    """
