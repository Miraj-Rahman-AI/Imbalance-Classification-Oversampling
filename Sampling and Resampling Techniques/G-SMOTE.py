...
class GeometricSMOTE(BaseOverSampler):
    ...
    def __init__(
        ...
        selection_strategy='combined',  # default combined
        k_neighbors=5,
        n_jobs=1,
    ):
    ...
    def _make_geometric_samples(self, X, y, pos_class_label, n_samples):
        """
            ...
            pos_class_label : str or int
                The minority class (positive class) target .
            ...
            y_new : ndarray, shape (n_samples_new, )
                Target values for s`ynthetic samples.
        """
        ...
        X_pos = X[y == pos_class_label]     # minority class
        ...
        X_new = np.zeros((n_samples, X.shape[1]))   # initial np.ndarray
